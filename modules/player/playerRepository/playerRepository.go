...
// func (r *playerRepository) DockedPlayerMoneyRes(pctx context.Context, cfg *config.Config, rep *payment.PaymentTransferRes) error {
// 	reqInBytes, err := json.Marshal(rep)
// 	if err != nil {
